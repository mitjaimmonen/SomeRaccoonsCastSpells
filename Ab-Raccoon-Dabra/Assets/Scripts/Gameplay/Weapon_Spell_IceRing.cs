...
public class Weapon_Spell_IceRing : Weapon_Spell {
	...
	protected override void Attack()
	{
		...
		Vector3 temppos = playerTrans.position;
		temppos.y -= playerTrans.GetComponent<Player>().playerCollider.height/2;
		GameObject tempIcicleGo = Instantiate(icicleEruptionPrefab, temppos, playerTrans.rotation);
